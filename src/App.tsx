...
const App: Component = () => {
  ...
  return (
    <div class="dark">
      <div
        class="h-screen lg:p-4 p-0.5 bg-primary flex items-stretch"
        style={{ "background-image": "" }}
      >
        <div class="bg-white bg-opacity-90 backdrop-blur border-white dark:border-gray-900 border-2 text-black dark:(bg-gray-800 bg-opacity-90 text-white) relative rounded-xl overflow-hidden shadow w-full flex items-stretch">
