  ...
  return (
    <>
      <div class="w-full">
        ...
        />
        <div class="w-full">
          <div class="bg-white dark:bg-gray-900 rounded-lg shadow p-4 mb-4 transition hover:(transform scale-105)">
            <p class="mb-4">
          ...
          <div class="p-4 shadow bg-white dark:bg-gray-900 rounded-lg mb-4 transition hover:(transform scale-105)">
